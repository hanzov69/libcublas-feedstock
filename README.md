...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/libcublas-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/libcublas-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add libcublas libcublas-dev libcublas-static
# for installing globally
pixi global install libcublas libcublas-dev libcublas-static
```
...
It is possible to list all of the versions of `libcublas` available on your platform:
...
```
pixi search libcublas --channel conda-forge
```
